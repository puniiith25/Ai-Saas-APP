    ...
    return (
        <>
            <div className='fixed z-5 w-full backdrop-blur-2xl flex justify-between item-center py-3 px-4 sm:px-5 xl:px-5'>
                ...
                {
                    user ? <UserButton /> : (<button onClick={() => openSignIn()} className='flex items-center gap-1 rounded-full  cursor-pointer bg-[#7086E0] text-white px-2.5  w-32 h-8'>Get started<ArrowRight className='w-4 h-4' /></button>)
                }
